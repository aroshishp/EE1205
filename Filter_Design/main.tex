...
\end{equation}
where $G_{BP}$ is the gain of the band-pass filter. The code in Listing 5 evaluates $G_{BP}$ and finds the coefficients of $H_{a, BP}$. We get $G_{BP} = 1.077$ by evaluating gain  
