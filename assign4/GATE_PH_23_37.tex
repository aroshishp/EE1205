...
Fourier Series of $V_{in}(t)$, visualized in \figref{fig:square_gate.ph.23.37}:
\begin{align}
...
Taking Fourier Transform of $V_{in}(t)$, plotted in \figref{fig:square_fft_gate.ph.23.37}:
\begin{align}
